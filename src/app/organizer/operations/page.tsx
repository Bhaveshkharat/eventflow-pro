           ...
           <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-1">
              ...
              <div className="flex items-center gap-2">
                 <div className="flex items-center gap-2 glass px-3 py-1.5 rounded-lg border border-white/5">
                    ...
                    <input placeholder="Search partners..." className="bg-transparent text-xs outline-none w-32 md:w-auto" />
                 </div>
              ...
              {partners.map(p => (
                <GlassCard key={p.name} className="p-4" hover={true}>
                   <div className="flex items-center gap-4">
                      <div className="h-10 w-10 rounded-xl glass border border-white/5 flex items-center justify-center text-primary shrink-0">
                      ...
                      <button className="h-8 w-8 rounded-lg glass grid place-items-center hover:bg-accent/50 transition-colors shrink-0">
