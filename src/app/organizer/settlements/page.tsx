           ...
           <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-1">
              ...
              <div className="flex items-center gap-2">
                 <div className="flex items-center gap-2 glass px-3 py-1.5 rounded-lg border border-white/5">
                    ...
                    <input placeholder="Search records..." className="bg-transparent text-xs outline-none w-32 md:w-auto" />
                 </div>
        ...
        <div className="lg:col-span-3 space-y-6">
           <GlassCard className="p-6" hover={false}>
              <h3 className="font-bold flex items-center gap-2 mb-6">
                 <span className="text-primary"><Calendar className="h-4 w-4" /></span> Next Payout
              </h3>
