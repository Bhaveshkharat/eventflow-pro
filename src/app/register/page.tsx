              ...
              {step === 4 && <div className="text-center py-6">
                ...
                <div className="mt-8 p-6 rounded-2xl glass-strong border border-primary/20 text-left bg-primary/5">
                   ...
                   <div className="grid grid-cols-2 gap-3">
                      <Link href="/hotel-agent" className="p-3 rounded-xl glass border border-white/5 hover:border-primary/30 transition-all flex flex-col gap-2 group">
                      ...
                      <Link href="/travel-agent" className="p-3 rounded-xl glass border border-white/5 hover:border-primary/30 transition-all flex flex-col gap-2 group">
                ...
                <Link href="/visitor" className="inline-block mt-8 w-full"><GradientButton className="w-full py-6" size="lg">Go to my dashboard <ArrowRight className="ml-2 h-5 w-5" /></GradientButton></Link>
              </div>}
            </motion.div>
          </AnimatePresence>
